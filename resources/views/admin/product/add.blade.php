                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('postAddProduct')}}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="quantity" class="form-control @error('quantity') is-invalid @enderror" name="quantity"></input>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="category_id" class="form-control @error('category_id') is-invalid @enderror" name="category_id"></input>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="cost" class="form-control @error('cost') is-invalid @enderror" name="cost"></input>
